...
const EVENT_DATA = {
  ...
  'robo-rumble': {
    ...
    stats: [{ val: '2–4', key: 'Team Size' }, { val: 'Rain Sensor + Humidity Sensor', key: '1st Prize' }, { val: 'Ultrasonic Sensor', key: '2nd Prize' }],
    coordinators: [
...
function updateCountdown() {
  const target = new Date('2026-04-11T17:00:00+18:00');
